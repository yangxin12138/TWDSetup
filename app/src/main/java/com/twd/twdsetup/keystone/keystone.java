...
public abstract class keystone {
    ...
    public void getKeystoneOrigin(Context context){
        ...
        /*if(originLT.equals(ORIGIN_NULL)){
            originLT = SystemPropertiesUtils.getProperty(PROP_LT,ORIGIN_NULL);
            SystemPropertiesUtils.setProperty(PROP_LT_ORIGIN,originLT);
        }
        if(originRT.equals(ORIGIN_NULL)){
            originRT = SystemPropertiesUtils.getProperty(PROP_RT,ORIGIN_NULL);
            SystemPropertiesUtils.setProperty(PROP_RT_ORIGIN,originRT);
        }
        if(originLB.equals(ORIGIN_NULL)){
            originLB = SystemPropertiesUtils.getProperty(PROP_LB,ORIGIN_NULL);
            SystemPropertiesUtils.setProperty(PROP_LB_ORIGIN,originLB);
        }
        if(originRB.equals(ORIGIN_NULL)){
            originRB = SystemPropertiesUtils.getProperty(PROP_RB,ORIGIN_NULL);
            SystemPropertiesUtils.setProperty(PROP_RB_ORIGIN,originRB);
        }*/
